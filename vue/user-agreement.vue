<template>
  <div :class="show ? 'user-agreement' : 'user-agreement hidden'">
    <div class="user-agreement-content">
      <div class="user-agreement-content-header">
        用户协议
        <canvas class="user-agreement-content-header-close" ref="close" width="22" height="22" @click="toggle"></canvas>
      </div>
      <div class="user-agreement-content-footer">
...
export default {
  ...
  mounted() { // 绘制关闭按钮
    let cxt = this.$refs.close.getContext('2d')
...
.user-agreement-content-header-close {
  position: absolute;
  right: 8px;
  top: 8px;
...
.user-agreement-content-header-close:hover {
  background-color: rgba(0, 0, 0, .2);
}

.user-agreement-content-footer {
  overflow-y: scroll;
